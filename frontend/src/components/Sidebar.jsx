...
function Sidebar({ activePage, onNavigate }) {
  return (
    <aside className="sidebar flex h-screen w-64 shrink-0 flex-col border-r border-white/[0.06] bg-surface/80 backdrop-blur-xl glass-surface">
            ...
            return (
              <li key={item.id}>
                <button
                  ...
                  className={`nav-item w-full rounded-lg px-3 py-2 text-left text-sm font-medium transition-colors ${
                    isActive
